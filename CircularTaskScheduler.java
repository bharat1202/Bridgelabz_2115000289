...
public void addAtBeginning(int taskId, String taskName, int priority,
String dueDate) {
...
public void addAtEnd(int taskId, String taskName, int priority, String
dueDate) {
Task newTask = new Task(taskId, taskName, priority, dueDate);
if (head == null) {
head = newTask;
...
public void addAtPosition(int position, int taskId, String taskName, int
...
if (currentTask != null) {
System.out.println("Task ID: " + currentTask.taskId + " | Name: "
+ currentTask.taskName + " | Priority: " + currentTask.priority + " | Due
...
Task temp = head;
do {
System.out.println("Task ID: " + temp.taskId + " | Name: " +
...
System.out.println("Task ID: " + temp.taskId + " | Name: " +
temp.taskName + " | Due Date: " + temp.dueDate);
}
temp = temp.next;
} while (temp != head);
}

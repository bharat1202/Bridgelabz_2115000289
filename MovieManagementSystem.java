...
public void addAtBeginning(String title, String director, int year, double
rating) {
...
public void addAtPosition(int position, String title, String director, int
year, double rating) {
if (position <= 1) {
...
Movie temp = head;
while (temp != null) {
if (temp.director.equalsIgnoreCase(director) || temp.rating ==
rating) {
System.out.println("Title: " + temp.title + " | Director: " +
temp.director + " | Year: " + temp.year + " | Rating: " + temp.rating);
}
temp = temp.next;
}
}
...
list.addAtPosition(2, "Zindagi Na Milegi Dobara", "Zoya Akhtar", 2011,
8.2);
System.out.println("All Movies (Forward):");
list.displayForward();
System.out.println("\nAll Movies (Reverse):");
list.displayReverse();
System.out.println("\nSearching for movies directed by Rajkumar
Hirani:");

...
public void addAtBeginning(int rollNumber, String name, int age, chargrade) {
...
public void addAtPosition(int position, int rollNumber, String name, intage, char grade) {
Student newStudent = new Student(rollNumber, name, age, grade);
if (position == 1) {
newStudent.next = head;
head = newStudent;
...
System.out.println("Student Found: " + temp.name + " | Age:
...
Student temp = head;
while (temp != null) {
System.out.println("Roll No: " + temp.rollNumber + " | Name: " +
